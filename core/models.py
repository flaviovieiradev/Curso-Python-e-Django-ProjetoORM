...
class Chassi(models.Model):
    numero = models.CharField('Chassi', max_length=17, help_text='Máximo 16 caracteres')
...
def set_default_montadora():
    return Montadora.objects.get_or_create(nome='Padrão')[0]    # Devolve (objeto, boolean)

class Carro(models.Model):
    """
        # OneToOneField
        Cada carro só pode se relacionar com um chassi e cada
        chassi só pode se relacionar com um carro.
